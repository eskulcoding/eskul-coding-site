...
function Section3() {
    ...
    return (
        <div className="px-8 sm:px-12 md:px-24 lg:px-36 2xl:px-72 flex flex-col space-y-16 md:flex-row justify-between items-center w-full relative py-20 md:py-40" ref={sectionRef}>
            <div className="w-full md:w-[45%] flex flex-col space-y-5" data-aos="fade-up">
                <h1 className="text-5xl md:text-5xl lg:text-6xl 2xl:text-[72px] font-bold leading-none">Bahasa <br/>Python</h1>
                <p className="">
            ...
            <div className="w-full md:w-[40%] flex flex-col space-y-2 md:absolute right-0">
